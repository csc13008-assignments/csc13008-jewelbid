-- Migration: Update products with brand, material, and targetAudience values
-- Based on product descriptions and names
...
WHERE id = '01940000-0001-7000-8000-000000000001';
...
WHERE id = '01940000-0002-7000-8000-000000000002';
...
UPDATE products SET
    ...
    "targetAudience" = 'Women'
WHERE id = '01940000-0003-7000-8000-000000000003';
...
UPDATE products SET
    ...
    material = 'Gemstone',
    "targetAudience" = 'Unisex'
WHERE id = '01940000-0004-7000-8000-000000000004';
...
UPDATE products SET
    ...
    material = 'Steel & Gold',
    "targetAudience" = 'Women'
WHERE id = '01940000-0005-7000-8000-000000000005';
...
UPDATE products SET
    ...
    material = 'Rose Gold',
    "targetAudience" = 'Women'
WHERE id = '01940000-0006-7000-8000-000000000006';
...
UPDATE products SET
    ...
    material = 'Platinum',
    "targetAudience" = 'Women'
WHERE id = '01940000-0007-7000-8000-000000000007';
...
UPDATE products SET
    ...
    material = 'Platinum',
    "targetAudience" = 'Women'
WHERE id = '01940000-0008-7000-8000-000000000008';
...
UPDATE products SET
    ...
    material = 'White Gold',
    "targetAudience" = 'Women'
WHERE id = '01940000-0009-7000-8000-000000000009';
...
UPDATE products SET
    ...
    material = 'Jade',
    "targetAudience" = 'Women'
WHERE id = '01940000-0010-7000-8000-000000000010';
...
UPDATE products SET
    ...
    material = 'Pearl',
    "targetAudience" = 'Women'
WHERE id = '01940000-0011-7000-8000-000000000011';
...
UPDATE products SET
    ...
    material = 'Gemstone',
    "targetAudience" = 'Unisex'
WHERE id = '01940000-0012-7000-8000-000000000012';
...
UPDATE products SET
    ...
    material = 'Rose Gold',
    "targetAudience" = 'Women'
WHERE id = '01940000-0013-7000-8000-000000000013';
...
UPDATE products SET
    ...
    material = 'Yellow Gold',
    "targetAudience" = 'Women'
WHERE id = '01940000-0014-7000-8000-000000000014';

-- Product 15: Natural Kashmir Sapphire 4.67ct Unheated Cornflower Blue
UPDATE products SET
    brand = 'Gübelin Certified',
    material = 'Gemstone',
    "targetAudience" = 'Unisex'
WHERE id = '01940000-0015-7000-8000-000000000015';
...
UPDATE products SET
    ...
    material = 'Pure Gold',
    "targetAudience" = 'Unisex'
WHERE id = '01940000-0016-7000-8000-000000000016';
...
UPDATE products SET
    ...
    material = 'Diamond',
    "targetAudience" = 'Unisex'
WHERE id = '01940000-0017-7000-8000-000000000017';

-- Product 18: Art Deco Diamond and Sapphire Bracelet Platinum
UPDATE products SET
    brand = 'Vintage Art Deco',
    material = 'Platinum',
    "targetAudience" = 'Women'
WHERE id = '01940000-0018-7000-8000-000000000018';
...
UPDATE products SET
    ...
    material = 'Rose Gold',
    "targetAudience" = 'Men'
WHERE id = '01940000-0019-7000-8000-000000000019';
...
UPDATE products SET
    ...
    material = 'Yellow Gold',
    "targetAudience" = 'Women'
WHERE id = '01940000-0020-7000-8000-000000000020';
